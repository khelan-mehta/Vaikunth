  ...
  return (
    <div className="flex p-[5rem] py-[2rem] w-[80vw]  ">
      <div className="flex flex-col w-full  p-3 rounded-[10px] h-[60vh] m-3">
        ...
        <div className="text-left mt-3 lato-light w-[80%] text-[22px]">
          Whether you're planning an intimate gathering or a grand celebration,
          our dedicated team ensures a memorable experience with personalized
          party booking services. At Vaikunth, indulge in exquisite cuisine
          while basking in the harmonious spirit of divine heritage.
        </div>
      ...
      <div className="flex">
        <Image src={mG} alt="mg" width={1100} height={90}  className="h-[60vh]"/>
      </div>
    </div>
  );
};
